...
const KvitteringKorreksjonTilbakekreving: FunctionComponent = () => {
    ...
    return (
        <HvitBoks>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <Innholdstittel>Tilbakekreving av refusjon</Innholdstittel>
                <EtikettInfo>
            ...
            <Normaltekst>
                ...
                fratrukket i denne korrigerte beregningen. Den nye beregningen viser at det vil kreves tilbake{' '}
                <b>{formatterPenger(refusjon.beregning?.refusjonsbeløp! * -1)}</b>.
            </Normaltekst>
...
export default KvitteringKorreksjonTilbakekreving;
